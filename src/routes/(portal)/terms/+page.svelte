				...
				<ol class="list-decimal pl-5">
					<li class="mb-6">
						...
						<p>
							...
							provided by <strong>[Your Company]</strong> (the “Service”). By using the Service,
					...
					<li class="mb-6">
						...
						<p>
							...
							software, is owned by <strong>[Your Company]</strong> or its licensors and protected
							by law.
						</p>
					</li>
					...
					<li class="mb-6">
						...
						<p>
							To the maximum extent permitted by law, <strong>[Your Company]</strong> will not be
					...
					<li class="mb-6">
						...
						<p>
							You agree to defend, indemnify, and hold harmless <strong>[Your Company]</strong>
					...
					<li class="mb-6">
						...
						<p>
							These Terms are governed by the laws of <strong>[your-jurisdiction]</strong>, without
							regard to conflict-of-laws rules. Venue and exclusive jurisdiction lie in the courts
							located in <strong>[your-venue]</strong>, unless applicable law requires otherwise.
						</p>
					</li>
